...
`check-avatar-lang.ts` el 2026-05-08: los md de `scaa/presentaciones/` que
...
2. Añadir el bloque `avatar-lang` al final del md, siguiendo
   `../../../019d8dc4-d3e0-76ca-b047-70e2b5b71674/avatar-mind/scaa/structure/data-structure/avatar-lang.md`
...
- `../../../019d8dc4-d3e0-76ca-b047-70e2b5b71674/avatar-mind/scaa/structure/data-structure/avatar-lang.md` — la regla 14 y la estructura canónica del bloque.
